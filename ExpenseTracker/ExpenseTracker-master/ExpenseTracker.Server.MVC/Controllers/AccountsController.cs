...
namespace ExpenseTracker.Server.MVC.Controllers
{
    public class AccountsController : Controller
    {
        ...
        {
            return View(_serviceClient.GetAccounts());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Account account = _serviceClient.GetAccountById(id.Value);
            if (account == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "IdAccount,Name")] Account account)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                _serviceClient.AddAccount(account);
        ...
        public ActionResult Edit([Bind(Include = "IdAccount,Name")] Account account)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                _serviceClient.UpdateAccount(account);
                return RedirectToAction("Index");
            }
            return View(account);
        }
        ...
        {
            _serviceClient.DeleteAccountById(id);
            return RedirectToAction("Index");
        }
